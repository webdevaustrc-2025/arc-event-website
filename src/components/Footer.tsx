    ...
    <footer className="relative overflow-hidden mt-0">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          style={{
            ...
            height: "700px",
            background:
              "radial-gradient(circle, rgba(58,130,80,0.06) 0%, transparent 65%)",
            filter: "blur(120px)",
            top: "-30%",
            left: "30%",
          }}
      ...
      <div className="absolute top-0 left-0 right-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(88,129,87,0.5) 20%, rgba(163,177,138,0.6) 50%, rgba(88,129,87,0.5) 80%, transparent 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(88,180,100,0.3) 30%, rgba(100,200,100,0.3) 50%, rgba(88,180,100,0.3) 70%, transparent 100%)",
            filter: "blur(4px)",
          }}
        />
      </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(58,90,64,0.6) 0%, rgba(88,129,87,0.4) 100%)",
            ...
            >
              Bangladesh's premier university robotics championship. Engineer
              the future with the best minds in the country.
            </p>
