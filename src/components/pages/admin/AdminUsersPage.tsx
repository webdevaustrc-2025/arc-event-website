  ...
  const fetchRegistrations = async () => {
    try {
      ...
      if (data && data.length > 0) {
        // Map database schemas to UI layout keys
                      ...
                      {user.status === "Pending" ? (
                        <div className="flex justify-end gap-2">
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-500 border border-green-500/20 transition-all"
                          >
